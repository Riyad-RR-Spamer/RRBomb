...
| $$  \ $$| $$  \ $$| $$  \ $$| $$  | $$| $$ | $$ | $$| $$  | $$
| $$  | $$| $$  | $$| $$$$$$$/|  $$$$$$/| $$ | $$ | $$| $$$$$$$/
|__/  |__/|__/  |__/|_______/  \______/ |__/ |__/ |__/|_______/ 
...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("RRBomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update RRBomb.")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("RRBomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting RRBomb")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("RRBomb was created by RR_TEAM")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("RRBomb will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['RR_TEAM', 't0xic0der', 'scpketer', 'Stefan']
...
description = """RRBomb - Your Friendly Spammer Application
...
parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by RR_TEAM !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start RRBomb with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start RRBomb with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start RRBomb with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update RRBomb")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current RRBomb contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current RRBomb version")
