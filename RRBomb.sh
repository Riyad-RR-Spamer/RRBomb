...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mRR \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border SpeedX
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           FACEBOOK GROUP: RR_TERMUX_COMMAND"
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UC4A2FT9dH6xki8fTeG6hXsA \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of RRBomb for more stability."
    echo " "
}
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN RRBomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
